...
int predict(string file_path, string model_name) {
...
int main(int argc, char** argv) {
    ...
    thread t1(predict, file_path_1, model_name);
    thread t2(predict, file_path_2, model_name);
    t1.join();
    t2.join();
