...
namespace NeuroDetection
{
    class Program
    {
        ...
        static Mat Rotate(Mat image, double angle)
        {
            ...
            Cv2.Resize(image, resizedImage1, newSize);
            Mat resizedImage2 = new Mat();
            Cv2.Resize(rotatedImage, resizedImage2, newSize);
            Cv2.ImShow("old image", resizedImage1);
            Cv2.ImShow("new image", resizedImage2);
            Cv2.WaitKey(0);
        ...
        static double GetAngle(float t)
        {
        ...
        static void Main(string[] args)
        {
            ...
            string directoryPathAsString = currentDirectory.ToString();

            Console.WriteLine(directoryPathAsString);

            SDK sdk = new SDK();
            // TODO: change to your test image folder path!
            string imageFolderPath = "C:\\Users\\NeuroBot\\Desktop\\disney\\angle_pic";
            ...
            string modelPath = "C:\\Users\\NeuroBot\\Desktop\\disney\\angle";
            // TODO: change to your model name!
            string modelName = "neuro_deteor";
            ...
            for (int iFile = 0; iFile < numFiles; ++iFile)
            {
                ...
                for (int i = 0; i < outResults.Length; ++i)
                {
                    ...
                    {
                        // 
                        DetectionResult r = outResults[i][j];
